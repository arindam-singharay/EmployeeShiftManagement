...
namespace EmployeeShiftManagement.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class ShiftDefinitionMapping : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shifts_ShiftDefinitions_ShiftDefinitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftDefinitions_Name",
                table: "ShiftDefinitions",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Shifts_EmployeeId_ShiftDate_ShiftDefinitionId",
                table: "Shifts",
                columns: new[] { "EmployeeId", "ShiftDate", "ShiftDefinitionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Shifts_ShiftDefinitionId",
                table: "Shifts",
